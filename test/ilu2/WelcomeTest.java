...
class WelcomeTest {
	...
	void test_EX10() {
		...
		assertEquals("Bob, Yoda, and Amy, Hello. AND YODA (x2) AND JERRY, HELLO !", wel.welcome("bob, yoda, amy, YODA, JERRY, YODA"));
		assertEquals("YODA (x2), HELLO !", wel.welcome("YODA, YODA"));
		assertEquals("Yoda (x2), Hello", wel.welcome("yoda, yoda"));
	}
